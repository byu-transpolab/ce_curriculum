...
The specific proposals we include in the remainder of this document are made with the intent to  
  ...
  - Introduce students to discipline areas earlier in the program.
...
A flowchart with the proposed changes is given in @fig-proposal. This proposal reduces the required credit hours to 121 from 128. The remainder of this document presents the changes by class year, along with a set of informal learning outcomes for each year. @sec-stories presents a series of “student stories” describing how a variety of students might approach a civil engineering degree in the new program, complete with individual flowcharts. 

![Proposed program flowchart (right-click to open larger in new tab).](flowcharts/FlowchartProposal.png){#fig-proposal}